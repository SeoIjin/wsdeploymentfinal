...
<div class="modal-overlay" id="confirmationModal">
  ...
  // Intercept the update form submission - FIXED SELECTOR
  ...
  function confirmUpdate() {
    ...
    const updateForm = document.querySelector('#updatePanel form');
    if (updateForm) {
      // Create a clone and submit to avoid the event listener
      const formClone = updateForm.cloneNode(true);
      updateForm.parentNode.replaceChild(formClone, updateForm);
      formClone.submit();
    }
  }
